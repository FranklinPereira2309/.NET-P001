        ...
        int numeroCasting = (int)numeroDouble; // convertido sem a parte fracionaria
        int numeroCastingArred = (int)Math.Round(numeroDouble); // A solução seria o aredondar 

        Console.WriteLine($"Número double: {numeroDouble}");
        Console.WriteLine($"Número double convertido com a perda da parte fracionária: {numeroCasting}");
